...
namespace FootballLeague.DataAccess.Migrations
{
    ...
    [Migration("20211217121506_RenameTeamScoreToTeamPoints")]
    partial class RenameTeamScoreToTeamPoints
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootballLeague.DataAccess.Data.Models.Match", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FootballLeague.DataAccess.Data.Models.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FootballLeague.DataAccess.Data.Models.Match", b =>
                {
                    b.HasOne("FootballLeague.DataAccess.Data.Models.Team", "HostingTeam")
                        .WithMany("HostedMatches")
                        .HasForeignKey("HostingTeamId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("FootballLeague.DataAccess.Data.Models.Team", "VisitingTeam")
